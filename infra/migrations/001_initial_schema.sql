...
CREATE TABLE run_steps (
  ...
  tool_name TEXT,
  tool_risk_class TEXT CHECK (tool_risk_class IN ('read_only','financial','destructive')),
...
CREATE TABLE tool_endpoints (
  ...
  tool_risk_class TEXT NOT NULL CHECK (tool_risk_class IN ('read_only','financial','destructive')),
